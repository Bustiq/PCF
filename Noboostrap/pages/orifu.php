...
<body  style="background-color: #f7f4f2; " >
 <header class="position-sticky top-0 " style="z-index:100000000">
  ...
  <nav class="navbar navbar-expand-lg bg-light mb-0" style="z-index: -1 !important;">
    ...
    <div class="header-section container" style="z-index: 1 !important;">
    <div class="logo"></div>
    <div>
    <i class="fas fa-shopping-cart cart" onclick="showCart(this)"></i>
    <p class="count-product">0</p>
    </div>
    <div class="cart-products" id="products-id" style="z-index: 1 !important;">
      ...
      if (mysqli_num_rows($resultado) > 0) {
        while ($fila = mysqli_fetch_assoc($resultado)) {  $platoID = $fila['idPlato'];?>
          <li class="cards_item" style="z-index: 1 !important;">
            ...
            <a href="#" data-id= "<?php $platoID?>" data-price="10.99" class="btn-add-cart">Add to Cart</a>
          </div>
              </div>
            </div>
          </li>
